...
Admin UI v2 supports light and dark themes with CSS custom properties:
...
Admin UI v2 automatically replaces the static HTML interface. No manual migration is required.
