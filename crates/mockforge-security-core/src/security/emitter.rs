...
/// # Example
/// ```no_run
/// use mockforge_security_core::security::emitter::init_global_siem_emitter;
/// use mockforge_security_core::security::siem::SiemConfig;
///
...
/// # Example
/// ```no_run
/// use mockforge_security_core::security::emitter::emit_security_event;
/// use mockforge_security_core::security::events::{SecurityEvent, SecurityEventType, EventActor};
///
/// # async fn example() {
