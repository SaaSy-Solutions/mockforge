...
pub use access_review::{
    ...
    ResourceAccessInfo, ReviewFrequency, ReviewStatus, ReviewType, UserAccessInfo,
    UserReviewConfig, UserReviewItem,
};
pub use access_review_global::{
    get_global_access_review_service, init_global_access_review_service,
    is_access_review_service_initialized,
};
...
pub use change_management::{
    ApprovalStatus, ChangeHistoryEntry, ChangeManagementConfig, ChangeManagementEngine,
    ChangePriority, ChangeRequest, ChangeStatus, ChangeType, ChangeUrgency,
};
pub use change_management_global::{
    get_global_change_management_engine, init_global_change_management_engine,
    is_change_management_engine_initialized,
};
pub use compliance_dashboard::{
    AlertSummary, AlertType, ComplianceAlert, ComplianceDashboardConfig, ComplianceDashboardData,
    ComplianceDashboardEngine, ComplianceGap, ComplianceStandard, ControlCategory,
    ControlEffectiveness, GapSeverity, GapStatus, GapSummary, RemediationStatus,
};
pub use compliance_dashboard_global::{
...
pub use justification_storage::{
    AccessJustification, InMemoryJustificationStorage, JustificationStorage,
};
pub use mfa_tracking::{InMemoryMfaStorage, MfaMethod, MfaStatus, MfaStorage};
pub use privileged_access::{
    PrivilegedAccessConfig, PrivilegedAccessManager, PrivilegedAccessRequest, PrivilegedAction,
    PrivilegedActionType, PrivilegedRole, PrivilegedSession, RequestStatus,
};
pub use privileged_access_global::{
    get_global_privileged_access_manager, init_global_privileged_access_manager,
    is_privileged_access_manager_initialized,
};
pub use risk_assessment::{
    Impact, Likelihood, Risk, RiskAssessmentConfig, RiskAssessmentEngine, RiskCategory, RiskLevel,
    RiskReviewFrequency, RiskSummary, TreatmentOption, TreatmentStatus,
};
pub use risk_assessment_global::{
