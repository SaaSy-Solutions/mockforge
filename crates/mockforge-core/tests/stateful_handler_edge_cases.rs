...
use mockforge_core::stateful_handler::{ResourceIdExtract, StatefulConfig, StatefulResponseHandler, StateResponse, TransitionTrigger};
...
async fn test_can_handle_with_config() {
    ...
    state_responses.insert("initial".to_string(), StateResponse {
        status_code: 200,
        headers: HashMap::new(),
    ...
    let config = StatefulConfig {
        resource_id_extract: ResourceIdExtract::PathParam { param: "id".to_string() },
...
async fn test_process_request_with_header_extraction() {
    ...
    let config = StatefulConfig {
        resource_id_extract: ResourceIdExtract::Header { name: "x-resource-id".to_string() },
        resource_type: "order".to_string(),
        state_responses,
        transitions: vec![],
    };
...
async fn test_process_request_with_query_param_extraction() {
    ...
    let config = StatefulConfig {
        resource_id_extract: ResourceIdExtract::QueryParam { param: "id".to_string() },
        resource_type: "order".to_string(),
        state_responses,
        transitions: vec![],
    };
...
async fn test_process_request_with_json_path_extraction() {
    ...
    let config = StatefulConfig {
        resource_id_extract: ResourceIdExtract::JsonPath { path: "user.id".to_string() },
        resource_type: "order".to_string(),
        state_responses,
        transitions: vec![],
    };
...
async fn test_process_request_with_composite_extraction() {
    ...
    let config = StatefulConfig {
        resource_id_extract: ResourceIdExtract::Composite {
            extractors: vec![
                ResourceIdExtract::PathParam { param: "id".to_string() },
                ResourceIdExtract::Header { name: "x-resource-id".to_string() },
            ],
        },
        resource_type: "order".to_string(),
        state_responses,
...
async fn test_process_request_with_transition() {
    ...
    state_responses.insert("processed".to_string(), StateResponse {
        status_code: 200,
        headers: HashMap::new(),
        body_template: "{}".to_string(),
        content_type: "application/json".to_string(),
...
async fn test_multiple_configs() {
    ...
    state_responses1.insert("initial".to_string(), StateResponse {
        status_code: 200,
        headers: HashMap::new(),
        body_template: "{}".to_string(),
        content_type: "application/json".to_string(),
    ...
    state_responses2.insert("initial".to_string(), StateResponse {
        status_code: 200,
        headers: HashMap::new(),
        body_template: "{}".to_string(),
        content_type: "application/json".to_string(),
