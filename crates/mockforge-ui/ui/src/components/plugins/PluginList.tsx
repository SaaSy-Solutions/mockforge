          ...
          <table className="min-w-full divide-y divide-border">
            <thead className="bg-muted">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Types</th>
            ...
            <tbody className="bg-card divide-y divide-border">
              {plugins.map((plugin) => (
                <tr key={plugin.id} className="hover:bg-accent hover:text-accent-foreground">
                  ...
                  <td className="px-6 py-4 text-sm text-foreground">{plugin.version}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-sm text-foreground">{plugin.author}</td>
                  <td className="px-6 py-4">
                    <DropdownMenu>
