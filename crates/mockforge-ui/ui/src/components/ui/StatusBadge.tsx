...
export function StatusBadge({ status, className, showDot = true, size = 'md' }: StatusBadgeProps) {
  const statusConfig = {
    ...
    running: {
      label: 'Running',
      bg: 'bg-success-50 bg-success-100',
      color: 'text-success-600 text-success-700',
      ring: 'ring-success-600/20 ring-green-300/40',
      dot: 'bg-success-500 bg-success-500',
    },
    warning: {
      label: 'Warning',
      bg: 'bg-warning-50 bg-warning-100',
      color: 'text-warning-600 text-warning-700',
      ring: 'ring-warning-600/20 ring-yellow-300/40',
      dot: 'bg-warning-500 bg-warning-500',
    },
    error: {
      label: 'Error',
      bg: 'bg-danger-50 bg-danger-100',
      color: 'text-danger-600 text-danger-700',
      ring: 'ring-danger-600/20 ring-red-300/40',
      dot: 'bg-danger-500 bg-danger-500',
    },
    stopped: { label: 'Stopped', bg: 'bg-neutral-100', color: 'text-neutral-600', ring: 'ring-neutral-200', dot: 'bg-neutral-400' },
    info: {
      label: 'Info',
      bg: 'bg-info-50 bg-info-100',
      color: 'text-info-600 text-info-700',
      ring: 'ring-info-600/20 ring-blue-300/40',
      dot: 'bg-info-500 bg-info-500',
    },
