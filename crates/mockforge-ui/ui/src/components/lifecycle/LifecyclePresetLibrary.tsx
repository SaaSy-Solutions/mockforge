...
const PRESET_COLORS: Record<string, string> = {
  subscription: 'bg-info-100 text-info-700 dark:bg-info-900/30 dark:text-info-300',
  loan: 'bg-success-100 text-success-700 dark:bg-success-900/30 dark:text-success-300',
