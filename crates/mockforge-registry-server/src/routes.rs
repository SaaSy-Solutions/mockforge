...
pub fn create_router(state: AppState) -> Router<AppState> {
    ...
    let auth_routes = Router::new()
        ...
        // User admin lookups (Phase B — admin-only)
        ...
        // Workspace environments (Postman-style; distinct from MockEnvironment dev/test/prod)
        .route(
            "/api/v1/workspaces/{workspace_id}/environments",
            get(handlers::workspace_environments::list_environments),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments",
            post(handlers::workspace_environments::create_environment),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments/order",
            axum::routing::put(handlers::workspace_environments::reorder_environments),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments/{environment_id}",
            axum::routing::put(handlers::workspace_environments::update_environment),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments/{environment_id}",
            delete(handlers::workspace_environments::delete_environment),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments/{environment_id}/activate",
            post(handlers::workspace_environments::activate_environment),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments/{environment_id}/variables",
            get(handlers::workspace_environments::list_variables),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments/{environment_id}/variables",
            post(handlers::workspace_environments::set_variable),
        )
        .route(
            "/api/v1/workspaces/{workspace_id}/environments/{environment_id}/variables/{variable_name}",
            delete(handlers::workspace_environments::remove_variable),
        )
        // Scenario promotions
