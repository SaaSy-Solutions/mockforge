...
//!
//! These types are shared across contract modules for mismatch reporting,
//! severity classification, and diff results. They originated from the
//! `ai_contract_diff::types` module in `mockforge-core`.
...
pub enum MismatchType {
    ...
    /// Semantic drift: nullable to non-nullable (hidden)
